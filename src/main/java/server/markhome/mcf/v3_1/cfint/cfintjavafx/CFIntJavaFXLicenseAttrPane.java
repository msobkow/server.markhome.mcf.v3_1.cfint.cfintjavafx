// Description: Java 25 JavaFX Attribute Pane implementation for License.
...
implements ICFIntJavaFXLicensePaneCommon
{
		...
		extends CFLabel
	{
		public IdCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.License.AttrPane.Id.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public IdEditor() {
			super();
			setFieldNameInzTag( "cfint.javafx.License.AttrPane.Id.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.License.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfint.javafx.License.AttrPane.Name.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DescriptionCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.License.AttrPane.Description.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DescriptionEditor() {
			super();
			setMaxLen( 1024 );
			setFieldNameInzTag( "cfint.javafx.License.AttrPane.Description.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public EmbeddedTextCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.License.AttrPane.EmbeddedText.EffLabel"));
		}
	}
		...
		extends CFTextEditor
	{
		public EmbeddedTextEditor() {
			super();
			setMaxLen( 8000 );
			setFieldNameInzTag( "cfint.javafx.License.AttrPane.EmbeddedText.EffLabel" );
			setPrefHeight( 10 * 20 );
			setMinHeight( 10 * 20 );
		}
	}
		...
		extends CFLabel
	{
		public FullTextCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.License.AttrPane.FullText.EffLabel"));
		}
	}
		...
		extends CFTextEditor
	{
		public FullTextEditor() {
			super();
			setMaxLen( 8000 );
			setFieldNameInzTag( "cfint.javafx.License.AttrPane.FullText.EffLabel" );
			setPrefHeight( 10 * 20 );
			setMinHeight( 10 * 20 );
		}
	}
