// Description: Java 25 JavaFX Attribute Pane implementation for Tld.
...
implements ICFIntJavaFXTldPaneCommon
{
		...
		extends CFLabel
	{
		public IdCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.Tld.AttrPane.Id.EffLabel"));
		}
	}
		...
		extends CFDbKeyHash256Editor
	{
		public IdEditor() {
			super();
			setFieldNameInzTag( "cfint.javafx.Tld.AttrPane.Id.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.Tld.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 64 );
			setFieldNameInzTag( "cfint.javafx.Tld.AttrPane.Name.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DescriptionCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.Tld.AttrPane.Description.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DescriptionEditor() {
			super();
			setMaxLen( 1024 );
			setFieldNameInzTag( "cfint.javafx.Tld.AttrPane.Description.EffLabel" );
		}
	}
