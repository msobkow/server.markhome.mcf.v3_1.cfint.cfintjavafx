// Description: Java 25 JavaFX Attribute Pane implementation for URLProtocol.
...
implements ICFIntJavaFXURLProtocolPaneCommon
{
		...
		extends CFLabel
	{
		public URLProtocolIdCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.URLProtocol.AttrPane.URLProtocolId.EffLabel"));
		}
	}
		...
		extends CFInt32Editor
	{
		public URLProtocolIdEditor() {
			super();
			setMinValue( ICFIntURLProtocol.URLPROTOCOLID_MIN_VALUE );
			setFieldNameInzTag( "cfint.javafx.URLProtocol.AttrPane.URLProtocolId.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public NameCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.URLProtocol.AttrPane.Name.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public NameEditor() {
			super();
			setMaxLen( 16 );
			setFieldNameInzTag( "cfint.javafx.URLProtocol.AttrPane.Name.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public DescriptionCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.URLProtocol.AttrPane.Description.EffLabel"));
		}
	}
		...
		extends CFStringEditor
	{
		public DescriptionEditor() {
			super();
			setMaxLen( 50 );
			setFieldNameInzTag( "cfint.javafx.URLProtocol.AttrPane.Description.EffLabel" );
		}
	}
		...
		extends CFLabel
	{
		public IsSecureCFLabel() {
			super();
			setText(Inz.s("cfint.javafx.URLProtocol.AttrPane.IsSecure.EffLabel"));
		}
	}
		...
		extends CFBoolEditor
	{
		public IsSecureEditor() {
			super();
			setIsNullable( false );
			setFieldNameInzTag( "cfint.javafx.URLProtocol.AttrPane.IsSecure.EffLabel" );
		}
	}
